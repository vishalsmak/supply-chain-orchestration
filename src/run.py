...
if __name__ == '__main__':
    try:
        ...
        if (platform.system() == 'Windows'):
            run_cmd('powershell -ExecutionPolicy bypass "& minikube -p minikube docker-env --shell powershell | Invoke-Expression; python setup.py --fresh_db=True"')
        else:
            run_cmd('eval $(minikube docker-env) && python setup.py --fresh_db=True')
